...
export type NewDocumentStorageData = Omit<DocumentStorageData, 'uniqueId'>
...
export interface IDriver {
     ...
     */
    loadById(uniqueId: string): Promise<DocumentStorageData | undefined>
     ...
     * @returns the document data, or `undefined` if does not exist
     */
    loadByName(ns: string, name: string): Promise<DocumentStorageData | undefined>
     ...
     */
    save(data: DocumentStorageData): Promise<void>
     ...
     */
    create(data: NewDocumentStorageData): Promise<DocumentStorageData>
